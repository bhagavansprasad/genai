...
def main():
    ...
    user_question = "Create a Python function with debug statements using pdbwhereami module to print Line number, function name, and call stack at appropriate places in the function"
